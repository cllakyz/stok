                                    ...
                                    <tr class="datatable-row row_<?php echo $d->id; ?>">
                                        ...
                                        <td class="text-center">
                                            <label class="custom-switch">
                                                <input type="checkbox" class="custom-switch-input"<?php echo $d->status == 1 ? " checked" : NULL; ?> data-controller="safe" data-id="<?php echo $d->id; ?>">
                                        ...
                                        <td class="text-right">
                                            <a class="btn btn-sm btn-icon btn-pill btn-success mt-1 mb-1" href="<?php echo SITE_URL."/safe/edit/$d->id"; ?>" data-toggle="tooltip" data-placement="top" title="Düzenle">
                                                <span class="btn-inner--icon"><i class="fe fe-edit"></i></span>
                                            </a>
                                            <a class="btn btn-sm btn-icon btn-pill btn-danger mt-1 mb-1" onclick="delete_item('safe', '<?php echo $d->id; ?>', this)" data-toggle="tooltip" data-placement="top" title="Sil">
