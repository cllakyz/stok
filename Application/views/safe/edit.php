    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card shadow">
                ...
                <form id="safe_edit_form" action="<?php echo SITE_URL."/safe/update/$data->id"; ?>">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <button type="button" class="mt-2 btn btn-block btn-secondary mt-1 mb-1" onclick="post_form('safe_edit_form')">GÜNCELLE</button>
                    </div>
                </form>
            </div>
        </div>
